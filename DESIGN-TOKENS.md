...
*Used in: dot field, search.html. Implemented as a vanilla JS constant — not a D3 scale.*

**Status as of May 28, 2026 — locked by James. Do not reassign without James sign-off.**

*Full rationale and decisions log: `ATLAS_VIZ_COLORS.md`*

### Active (9 confirmed categories)
...
// Flat ordered array for D3 / sequential use:
...
### Pending activation (waiting on Ryan to confirm taxonomy slugs)

| Category (working title) | Hex |
|--------------------------|-----|
...
### Reserve slots (unassigned)

⚠ These three are too light for dark backgrounds as-is — must be darkened before activation.
...
- Do not activate pending additions until Ryan confirms category names and slugs
...
| May 28, 2026 | ATLAS_VIZ_COLORS locked by James — 9 active categories assigned | Corrects placeholder that was in DESIGN-TOKENS since Apr 2026; 6 pending + 3 reserve documented |
