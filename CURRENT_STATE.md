...
- **Liz (`liz-editorial`)** — built, `.claude/agents/liz-editorial.md` in the Atlas Spidering workspace (not this repo). **Read-only**: `~/Downloads/ATLAS-EDITORIAL-STANDARDS-v1_4.md` + the Global Correspondents session note (`Atlas Spidering/sessions/row_bluesky_global_correspondents_clusters_2026-07-02.md`). No Bash/Write/Edit tools.
